import {getNotifications, createNotification,getNotificationsByResidentId, updateNotification, deleteNotification} from '../controllers/notification.controller'
...
router.get("/", decryptFields(SENSITIVE_FIELDS), getNotifications)
